...
//                    }
                ...
                val spo2Highest =
                        when(pulseOximetryList[i].spo2Highest.toFloat() == pulseOximetryList[i].spo2Lowest.toFloat()){
                            false -> pulseOximetryList[i].spo2Highest.toFloat()
                            true -> pulseOximetryList[i].spo2Highest.toFloat() + .3f
                        }
...
//                LogUtil.logD("getSpO2CandleData", pulseOximetryList[i].data.SpO2Lowest.toFloat())
                ...
                when{
                    ...
                    pulseOximetryList[i].spo2Highest >= 95 && pulseOximetryList[i].spo2Lowest >= 95 -> {

                        arrayList.add(CandleEntry(
                                calXIndex(pulseOximetryList[i].takenAt) +
                                        when(timeformat) {
                                ...
                                spo2Highest,
                                spo2Highest,
                                pulseOximetryList[i].spo2Lowest.toFloat(),
                                null
                        ))
                    }

                    pulseOximetryList[i].spo2Highest >= 90 && pulseOximetryList[i].spo2Lowest >= 90 -> {
