...
object DeviceKey {
    ...
    const val DEVICE_SKU_BP_X3 = "RM_BP_X3"
    const val DEVICE_SKU_BP_X5 = "RM_BP_X5"
    const val DEVICE_SKU_TM_HC700 = "RM_TM_HC700"
    const val DEVICE_SKU_BG_HT100 = "RM_BG_HT100"
    const val DEVICE_SKU_OXIMETER_SB210 = "RM_PO_SB210"
    const val DEVICE_SKU_FAT_SCALE_LS212B = "RM_BF_LS212-B"
